                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    <select name="type" class="form-control" id="type">
                                       <option value="RESERVATION" {{$data->type == "RESERVATION" ? "selected":false}}>When User Make Reservation</option>
                                       <option value="SPECIALDAY"{{$data->type == "SPECIALDAY" ? "selected":false}}>When User Make Reservation on Special Day</option>
                                       <option value="TOTALSPEND"{{$data->type == "TOTALSPEND" ? "selected":false}}>When User Make Reservation with Total Spend</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                <select name="id_reward" class="form-control" id="id_reward">
                                   <option value="">-- Choose the reservation type first</option>
                                   @foreach($reward as $rwd)
                                   <option value="{{$rwd->id}}" {{$data->id_reward == $rwd->id ? "selected":false}}>User will get :
                                    ...
                                    <div class="row" >
                                        <div class="col-md-6" id="special_date">
                                            ...
                                            <label>User must make a reservation on </label>
                                                <div class="input-group input-group-alternative">
                                                    ...
                                                    <input class="form-control datepicker" data-date-start-date="+1d" id="reservation_date" name="reservation_date" placeholder="Select date" type="text" value="{{$data->reservation_date}}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6" id="min_transaction" style="display:none;">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="min_transaction" value="{{$data->min_transaction}}" value=0  class="form-control" placeholder="put the minimum spend value here">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="reservation_required" class="form-control" >
                                                @for($i=1;$i<=10;$i++)
                                                <option value="{{$i}}" {{$data->reservation_required == $i ? "selected":false}}>User must do {{$i}} {{$i == 1 ? "time" : "times"}} reservation</option>
                                                @endfor
                                            </select>
                                        </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="total_spend" value="{{$data->total_spend}}"  class="form-control" placeholder="put the total spend value here">
                                        </div>
                                        </div>
                                        ...
                                        <div class="col-md-6" id="is_multiple_reservation" >
                                            <div class="form-group">
                                                ...
                                                <select name="is_multiple_reservation" class="form-control">
                                                    <option value="0" {{$data->is_multiple_reservation == 0 ? "selected":false}}>Single Reservation</option>
                                                    <option value="1" {{$data->is_multiple_reservation == 1 ? "selected":false}}>Multiple Reservation</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-12" id="reservation_status" >
                                            <div class="form-group">
                                                ...
                                                <select name="reservation_status" class="form-control">
                                                    <option value="0" {{$data->reservation_status == 0 ? "selected":false}}> ON HELD</option>
                                                    <option value="1" {{$data->reservation_status == 1 ? "selected":false}}> COMPLETED</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            ...
                            <div class="custom-control custom-radio mb-3">
                                <input type="radio" name="status" class="" value="1" {{$data->exists && $data->status == 1 ? 'Checked': 'checked' }} > Active
